<template>
    <div class="principal">
        ...
        <div class="botoes">
            <router-link class="nav-button" to="/mulher">
                <button class="principal-botao">Coleção Verão Mulher</button>
            </router-link>
            <router-link class="nav-button" to="/homem">
                <button class="principal-botao">Coleção Verão Homem</button>
            </router-link>
        </div>
    </div>
</template>
