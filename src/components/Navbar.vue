<template>
    <div class="navbar" :class="{ alterar_cor : scrollPosition > 200 }">
        ...
        <div class="direita">
            <div class="buscar">
                <router-link class="buscarCaixa" to="/">
...
.navbar .centro .navlink .nav-page {
    text-decoration: none;
    color: #fff;
    font-size: 0.8rem;
    padding: 0em 0.4em;
